...
> статуси сторінок застаріли (усі позначені тут «У роботі»/«Заплановано»
> давно опубліковані); маршрути дублюються актуальним
> `docs/SITE_STRUCTURE.md`, а контент — `content/{ua,en,pl}/`. Не є
> чинним джерелом істини; лишений лише як історичний запис.
