...
Стан на 2026-09-22 (T-001): піддомен `preview` разом із файлами
видалено на хостингу, його окремий DNS-запис видалено. У DNS
лишається wildcard-запис `*.sibway.com.ua` (A → сервер хостингу), тому
`preview.sibway.com.ua`, як і будь-який інший неіснуючий піддомен,
резолвиться й показує лише стандартну заглушку Cityhost — без контенту
Sibway і без ризику дублікатів. Wildcard свідомо залишено (рішення
власника), щоб не зачепити інші сервіси домену.
